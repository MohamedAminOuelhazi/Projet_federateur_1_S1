...
\\ \hline
\multirow{4}{8em}{Chatbot IA}
& En tant que patient, je veux accéder et recevoir des réponses intelligentes basées sur l'IA (OpenAI API) & Élevée & 4 jours
\\ \hline
...
\begin{figure}[H]%
    ...
    \includegraphics[width=14cm,height=13cm]{images/patient d.jpg}%
...
\begin{figure}[H]%
    ...
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=16cm,height=14cm]{images/patient 1.jpg}%
...
\begin{figure}[H]%
    ...
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=16cm,height=14cm]{images/sequenceOPENAI.jpg}%
...
\textbf{Page d'inscription patient}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=14cm,height=11cm]{images/creer-patient-assistant.png}%
    \caption{Formulaire d'inscription avec email, nom, prénom, mot de passe, confirmation}%
\end{figure}

\textbf{Email de vérification}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Page de confirmation de vérification}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Liste des dossiers médicaux}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Détails d'un dossier médical}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
