...
\begin{figure}[H]%
    ...
    \includegraphics[width=14cm,height=12cm]{images/medcin_use.jpg}%
...
\begin{figure}[H]%
    ...
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=15cm,height=13cm]{images/Medcin2.jpg}%
...
\begin{figure}[H]%
    ...
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=15cm,height=13cm]{images/medcin_3.jpg}%
...
\begin{figure}[H]%
    ...
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=15cm,height=14cm]{images/medcin_1.jpg}%
...
\textbf{Page de connexion médecin}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Dashboard médecin avec statistiques}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Profil détaillé d'un patient}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Formulaire de création de rendez-vous}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Liste des rendez-vous avec filtres}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Formulaire de création d'assistant}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Modification d'un dossier médical}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Historique des dossiers médicaux d'un patient}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Upload de documents médicaux}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Liste des factures avec filtres}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Formulaire de création de facture}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Enregistrement d'un paiement}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Rapports financiers détaillés}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
...
\textbf{Filtres et export de rapports}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=16cm,height=10cm]{images/rapports-financiers.png}%
...
\textbf{Profil médecin}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=14cm,height=11cm]{images/profil-medecin.png}%
    \caption{Formulaire de modification du profil avec nom, email, téléphone}%
\end{figure}

\textbf{Paramètres du cabinet}
\begin{figure}[H]%
    \center%
    \setlength{\fboxsep}{5pt}%
    \setlength{\fboxrule}{0.5pt}%
    \includegraphics[width=16cm,height=11cm]{images/parametres-cabinet.png}%
    \caption{Changement de mot de passe sécurisé et préférences de notification}%
\end{figure}
